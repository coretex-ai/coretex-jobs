...
NetworkManager.instance().authenticate("demo@biomech.us", "Qwebnm11.") # pass your login credentials here username and password
filePath = "/Users/bogdanbm/Documents/working/biomech/source/experiment-templates/bio-bodysite-prediction/dataForUpload/samples-otus.90.mapped" # path to atlas .mapped file
infoPath = "/Users/bogdanbm/Documents/working/biomech/source/experiment-templates/bio-bodysite-prediction/dataForUpload/samples.env.info.zip"
listOfFiles = []
